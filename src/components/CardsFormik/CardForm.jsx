...
export const CardForm = React.memo(({ name, sum, measure }) => {
  ...
  const errors = {};
    const onBlurCostFunc = (e) => {
      console.log(e.currentTarget.value)
      if (!e.currentTarget.value) {
          errors.cost = 'Обязательное поле';
          e.currentTarget.value = 1000000
        //   cost_rangeElement.current.value =  1000000
        ...
        //   values.cost_range = 6000000
          ...
          dispatch(setCostTC(e.currentTarget.value))
        //   cost_rangeElement.current.value = e.currentTarget.value
           // values.cost_range =  values.cost 
          //   cost_range.current.value
      }
      console.log(errors)
  }
    const  onBlurCostRangeFunc = (e) => {
        console.log('onBlurCostRangeFunc', e.currentTarget.value)
    }
    ...
    return (
        <div>
            <Formik
                ...
                validate={values => {   //onBlur Behaviour
                    const errors = {};
                    ...
                    if (!values.cost_range) {
                        ...
                        // values.cost = values.cost_range
                        // dispatch(setCostTC(values.cost_range))
                    }
                    ...
                    <form 
                        ...
                        <label >
                            ...
                            <input 
                                ...
                                name="cost_range"
                                onChange={ handleChange }
                                onBlur={(e) => onBlurCostRangeFunc(e)}
